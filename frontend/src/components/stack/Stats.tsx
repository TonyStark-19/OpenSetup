    ...
    return (
        <div className="flex flex-row justify-center items-center gap-6 md:gap-14 border-t border-[#262629]/60 py-6 mt-16 max-w-4xl w-[90%] px-4 z-10 select-none">
            <div className="flex flex-col justify-center items-center text-center">
                <h4 className="text-[#EDEEF0] text-xl md:text-2xl font-bold tracking-tight">50+</h4>
            ...
            <div className="flex flex-col justify-center items-center text-center">
                <h4 className="text-[#EDEEF0] text-xl md:text-2xl font-bold tracking-tight">20+</h4>
            ...
            <div className="flex flex-col justify-center items-center text-center">
                <h4 className="text-[#EDEEF0] text-xl md:text-2xl font-bold tracking-tight">100%</h4>
