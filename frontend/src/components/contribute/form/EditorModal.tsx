            ...
            >
                ...
                <div className="flex border border-zinc-200 dark:border-zinc-800 rounded-md p-0.5 bg-white dark:bg-zinc-900">
                    <button
                        ...
                        ${editorViewMode === "edit" ? "bg-zinc-100 dark:bg-[#1c1c21] text-zinc-900 dark:text-white shadow-sm"
                    ...
                    <button
                        ...
                        className={`px-2.5 py-1 rounded text-[11px] font-medium cursor-pointer transition-all duration-200 
                        ${editorViewMode === "preview" ? "bg-zinc-100 dark:bg-[#1c1c21] text-zinc-900 dark:text-white shadow-sm"
                                : "text-zinc-400 hover:text-zinc-600"}`
                        }
                    >
                        Preview
