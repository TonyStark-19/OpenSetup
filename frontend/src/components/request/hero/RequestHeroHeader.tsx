...
export default function RequestHeroHeader() {
    return (
        <div className="w-full max-w-3xl flex flex-col items-center text-center select-none mb-8 sm:mb-10 px-2 sm:px-4">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold tracking-tight mb-4 sm:mb-5 leading-tight">
                Missing a guide? <br />
                <span className="text-zinc-400 dark:text-zinc-600">You're not</span> the only one.
            </h1>

            <p className="text-zinc-500 dark:text-[#888a8e] text-xs sm:text-sm md:text-base max-w-sm sm:max-w-lg leading-relaxed px-2 sm:px-0">
