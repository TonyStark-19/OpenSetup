...
import rawMarkdownContent from "../../guides/vite-react-ts.md?raw";
    ...
    return (
        <div className="w-full max-w-4xl mx-auto bg-[#0c0c0e] border border-[#212124] rounded-2xl overflow-hidden shadow-2xl text-[#EDEEF0] font-sans my-12">
            ...
            <div className="bg-[#121215] border-b border-[#212124] px-4 py-3 flex items-center justify-between select-none">
                ...
                <div className="bg-[#0a0a0c] border border-[#212124] rounded-lg px-3 py-1 text-xs text-[#888a8e] flex items-center gap-1.5 font-mono">
            ...
            <div className="p-6 md:p-8">
                {viewMode === "preview" ? (
                    <div className="prose prose-invert max-w-none text-left select-text">
                        {/* Custom Component Mapping directly inside ReactMarkdown */}
                        <ReactMarkdown
                            components={{
                                ...
                                // Intercept raw codeblocks and turn them into your signature premium code boxes
                                    ...
                                    return className ? (
                                        <div className="my-5 space-y-2 w-full">
                                            <div className="bg-[#070708] border border-[#1c1c1f] rounded-xl overflow-hidden font-mono text-[13px] leading-relaxed">
                                                <div className="bg-[#0c0c0e] border-b border-[#1c1c1f] px-4 py-2 flex items-center justify-between text-[#525256] text-xs font-sans">
                                        ...
                                        // Inline micro-code tokens (like `npm install`)
                    ...
                    /* Raw Markdown Source Output View */
                    <div className="space-y-4 text-left select-text">
                        ...
                        {/* Swapped to a native <pre> block with exact spacing constraints */}
                        <pre className="bg-[#070708] border border-[#1c1c1f] rounded-xl p-5 font-mono text-[13px] text-[#b5b7ba] whitespace-pre-wrap break-all leading-relaxed m-0 overflow-x-auto">
